 ...
 *
 */
void MOSTRARMASCOTA(eMascota mascotas[],eTipo tipos[], eColor colores[], int index, int tamMasc, int tamT, int tamC);
 ...
 *
 */
void MOSTRARMASCOTABYID (eMascota mascotas[],eTipo tipos[], eColor colores[], int index, int tam, int tamT, int tamC);
